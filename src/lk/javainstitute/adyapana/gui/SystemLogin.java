...
public class SystemLogin extends javax.swing.JFrame {
   ...
   private void setPlaceholder() {
        ...
        jTextField1.putClientProperty(FlatClientProperties.STYLE, "margin:0,10,0,10");
        ...
        jPasswordField1.putClientProperty(FlatClientProperties.STYLE, "margin:0,10,0,10");
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/lk/javainstitute/adyapana/recources/logo.png"))); // NOI18N
        ...
        if (username.isEmpty()) {
            ...
            try {
                ...
                if (resultSet.next()) {
                    ...
                    JOptionPane.showMessageDialog(this, "Username or Password does not match", "Warning", JOptionPane.WARNING_MESSAGE);
                }
            } catch (Exception e) {
